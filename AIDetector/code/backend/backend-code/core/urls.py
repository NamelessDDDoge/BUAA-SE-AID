...
urlpatterns = [
    ...
    path('admin/tasks/<int:task_id>/report/', views_admin.download_task_report_admin, name='download_task_report_admin'),
    path('get_review_request_detail/<int:manual_review_id>/', views_admin.get_review_request_detail, name='get_review_request_detail'),
    path('reviewer/manual-review/<int:manual_review_id>/report/', views_admin.download_reviewer_task_report, name='download_reviewer_task_report'),
